            ...
            <div className="container">
                <div className="pt-16 md:pt-32 pb-20">
                    <div className="flex items-center justify-between gap-2 border-b border-black/25 pb-7 mb-9 md:mb-16">
                        <h2>Contact Me</h2>
                        <p className="text-xl text-blue-500">( 05 )</p>
                    </div>
                        ...
                        <div className="flex flex-col sm:flex-row md:flex-col justify-between gap-5 md:gap-20 items-center md:items-end">
                            ...
                            <div className="flex flex-wrap justify-center gap-5 lg:gap-11 items-end">
                                {contactData?.contactInfo?.map((value: any, index: any) => {
                                    return (
                                        <div key={index}>
                                            <Link href={value?.link} className="text-base lg:text-lg text-black font-normal border-b border-black/25 pb-3 hover:text-primary hover:border-primary">{value?.label}</Link>
                                        </div>
                                    )
                                })}
                            </div>
